...
{
    static char gameBuffer[sizeof(BirdEye::BirdEyeGame)];

    ISystem* system = m_Framework->GetISystem();
    ModuleInitISystem(system, "BirdEye");

    m_Game = new(reinterpret_cast<void*>(gameBuffer)) BirdEye::BirdEyeGame();
