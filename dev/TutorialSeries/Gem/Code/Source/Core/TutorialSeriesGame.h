 ...
 */
#define GAME_NAME           "TUTORIALSERIES"
#define GAME_LONGNAME       "LUMBERYARD TUTORIALSERIES"
...
namespace TutorialSeries
{
    ...
    SC_API extern TutorialSeriesGame* g_Game;
} // namespace TutorialSeries